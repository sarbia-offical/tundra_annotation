...
export function FancySwitch<T extends OptionType>({
  ...
  console.log("highlighterClassName", highlighterClassName);
  console.log("highlighterStyle", highlighterStyle);
  console.log("customHighlighterStyle", customHighlighterStyle);
